...
/** Basic user sign-in against the FastAPI JWT backend. */
    ...
    <div className="flex h-screen w-full items-center justify-center bg-gradient-to-br from-teal-500/5 via-background to-cyan-500/5 px-4">
      ...
      >
        ...
        <div className="mb-7 flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-xs text-muted-foreground">Demo: user@company.com / User123!</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Input id="password" type="password" required value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" className="focus-visible:ring-teal-500" />
          </div>
          <Button type="submit" className="mt-1 bg-teal-600 hover:bg-teal-600/90" disabled={busy}>
