...
/**
 * Entry point for signing in. Two distinct doors: the everyday Agentic Trainer
 * workspace for team members, and a separately-styled Admin Console for
 * platform administrators. Each leads to its own themed sign-in screen.
 */
    ...
    <div className="flex min-h-screen w-full flex-col items-center justify-center bg-gradient-to-br from-atlas-indigo/5 via-background to-atlas-emerald/5 px-4 py-12">
      ...
      <div className="grid w-full max-w-[720px] grid-cols-1 gap-5 sm:grid-cols-2">
        ...
        >
          ...
          <h2 className="text-base font-extrabold text-foreground">Team member sign-in</h2>
          <p className="mt-1.5 text-[13px] leading-relaxed text-muted-foreground">
            Ask Atlas questions, browse the knowledge repository, and upload SME material.
          </p>
